...
.pivot-table td.label-col {
    font-family: 'DM Sans', sans-serif;
    font-size: 12px;
    color: #e0e3ed;
}

.pivot-table td.num-col {
    text-align: right;
}

.pivot-table td.abandon-high {
    color: #ff6b6b;
    font-weight: 600;
}

.pivot-table td.abandon-med {
    color: #ffa94d;
}

.pivot-table td.abandon-low {
    color: #69db7c;
}
...
<div class="header">
  <div>
    <h1>DEXIT Global Helpdesk - Call Report</h1>
...
<div class="footer">DEXIT Global Helpdesk Dashboard | {date_str} | This report is auto-generated. Do not edit manually.</div>
</body></html>"""
...
<div class="header">
  <div>
    <h1>DEXIT Global Helpdesk - Mail Report</h1>
